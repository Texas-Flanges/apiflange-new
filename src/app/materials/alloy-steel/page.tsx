...
const mechanicalColumns = [
  ...
  { key: 'f11', label: 'F11', unit: '' },
  { key: 'f22', label: 'F22', unit: '' },
  { key: 'f5', label: 'F5', unit: '' },
  { key: 'f9', label: 'F9', unit: '' },
  { key: 'f91', label: 'F91', unit: '' },
];
...
const temperatureColumns = [
  { key: 'grade', label: 'Grade', unit: '' },
  { key: 'design', label: 'Design Temp', unit: '' },
  { key: 'continue', label: 'Continuous Service', unit: '' },
  { key: 'intermittent', label: 'Intermittent Max', unit: '' },
];
...
const deratingColumns = [
  ...
  { key: 'f11', label: 'F11 Rating', unit: '% of base' },
  { key: 'f22', label: 'F22 Rating', unit: '% of base' },
  { key: 'f5', label: 'F5 Rating', unit: '% of base' },
  { key: 'f91', label: 'F91 Rating', unit: '% of base' },
];
  ...
  return (
    <>
      ...
      <SectionWrapper className="py-16 md:py-24 bg-gray-50">
        <Container>
          ...
          <div className="mt-8 bg-white p-8 rounded-lg border border-gray-200">
            <h3 className="text-xl font-bold text-gray-900 mb-4">Property Notes</h3>
            <ul className="space-y-4">
              <li className="flex items-start gap-4">
                <span className="text-brass font-bold text-2xl">•</span>
                <div>
                  <p className="font-bold text-gray-900">Tensile Strength</p>
                  <p className="text-gray-700 text-sm">
                    Minimum values shown. F91 and F9 have higher tensile (75 ksi) enabling higher pressure
                    ratings at elevated temperature.
                  </p>
                </div>
              </li>
              <li className="flex items-start gap-4">
                <span className="text-brass font-bold text-2xl">•</span>
                <div>
                  <p className="font-bold text-gray-900">Yield Strength</p>
                  <p className="text-gray-700 text-sm">
                    Increases with chromium content. F91 (50 ksi) yields higher than F11 (35 ksi), providing
                    stronger margin against plastic deformation.
                  </p>
                </div>
              </li>
              <li className="flex items-start gap-4">
                <span className="text-brass font-bold text-2xl">•</span>
                <div>
                  <p className="font-bold text-gray-900">Elongation</p>
                  <p className="text-gray-700 text-sm">
                    All grades exceed 15% elongation, ensuring adequate ductility. F91 at 20% provides best
                    ductility, reducing brittleness risk.
                  </p>
                </div>
              </li>
              <li className="flex items-start gap-4">
                <span className="text-brass font-bold text-2xl">•</span>
                <div>
                  <p className="font-bold text-gray-900">Hardness</p>
                  <p className="text-gray-700 text-sm">
                    Measured in Brinell. F9 at 280 HB is harder, providing wear resistance. Hardness is
                    controlled through heat treatment during manufacturing.
                  </p>
                </div>
              </li>
            </ul>
        ...
        <Container>
          ...
          <div className="mt-12 grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-red-50 p-8 rounded-lg border border-red-200">
              <h3 className="text-xl font-bold text-gray-900 mb-4">Design vs. Continuous Temperature</h3>
              <p className="text-gray-700 mb-4">
                <span className="font-bold">Design Temperature</span> is the maximum temperature used in
                calculations per ASME Section VIII. Flanges are rated to this temperature assuming proper
                equipment design and margin.
              </p>
              <p className="text-gray-700">
                <span className="font-bold">Continuous Service</span> is the maximum temperature for
                indefinite operation. Temperatures above this are intermittent only. For example, F22 design
                temperature is 1050°F, but continuous service is limited to 1000°F.
              </p>
            </div>

            <div className="bg-orange-50 p-8 rounded-lg border border-orange-200">
              <h3 className="text-xl font-bold text-gray-900 mb-4">Creep Rupture Life</h3>
              <p className="text-gray-700 mb-4">
                Alloy steel selection is often driven by<span className="font-bold"> creep rupture life</span>.
                Standards like ASME assume 100,000 hours (11.4 years) minimum creep rupture strength.
              </p>
              <p className="text-gray-700">
                F91 provides superior creep rupture life compared to F22 and F9 at 1050-1100°F, enabling
                extended equipment life and higher capital investment justification.
              </p>
            </div>
          </div>
        </Container>
      ...
      <SectionWrapper className="py-16 md:py-24 bg-gray-50">
        <Container>
          <h2 className="text-3xl font-bold text-gray-900 mb-12">
            Pressure Rating Derating with Temperature
          </h2>

          <p className="text-lg text-gray-700 mb-8">
            ASME Section VIII derate flange pressure ratings as temperature increases. This table shows
            the derating factor for each grade. For example, at 800°F, an F11 Class 600 flange is derated
            to 75% of its 68°F rating.
          </p>

          <SpecTable columns={deratingColumns} data={deratingData} />

          <div className="mt-8 bg-blue-50 p-8 rounded-lg border border-blue-200">
            <h3 className="text-xl font-bold text-gray-900 mb-3">Reading the Derating Chart:</h3>
            <p className="text-gray-700 mb-4">
              At 1000°F, F11 is derated to only 30% capacity, making it unsuitable for this temperature.
              F22 maintains 65%, F5 maintains 85%, and F91 maintains 95%. This demonstrates why F91 is
              increasingly specified for high-temperature power plants—it maintains higher pressure ratings
              at extreme temperatures.
            </p>
            <p className="text-gray-700">
              Always consult ASME Section VIII Appendix Z for exact pressure derate curves. These simplified
              percentages are representative only.
            </p>
          </div>
        </Container>
      </SectionWrapper>
